        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 px-0">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#" className="text-black hover:text-slate-700 transition-colors">Documentation</a>
              <a href="#" className="text-black hover:text-slate-700 transition-colors">Support</a>
            </div>
          </div>
